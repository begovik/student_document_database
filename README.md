...
- **Discovery**: активні адаптери DDGS та OpenAlex; Crossref, Unpaywall і OAI-PMH залишені як явно вимкнені етапи roadmap до появи адаптерів і тестів
...
- PDF-файли зберігаються лише тимчасово для верифікації/витягу і видаляються після обробки; у БД та каталогах залишаються метадані, URL і SHA-256
...
- **v1.0**: OAI-PMH, sitemap scanner та інші discovery-адаптери після окремої реалізації й тестування
